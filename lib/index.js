...
var iZhui = Class.extends({
	...
	load: function(path,f){
        ...
        var file = f.replace(path+Path.sep,'');
	...
	loadModel: function( paths, file ){
		...
		var model = Model.define( name, modelSource.schema, modelSource.before, modelSource.after , modelSource.method, modelSource.collection , modelSource.toJSON );
